...
public class WeatherAPIData {
    ...
    // Method to get weather data based on user input for testing
    public void getData() {
        try{
            ...
            do{
                ...
                System.out.println(displayWeatherData(latitude, longitude));
    ...
    public static String getWeather(String city){
        try{
            // Get location data
            JSONObject cityLocationData = (JSONObject) getLocationData(city);
            if(cityLocationData == null) return "Error: Could not find location data for " + city;
            double latitude = (double) cityLocationData.get("latitude");
            double longitude = (double) cityLocationData.get("longitude");
        ...
        return "Error: Could not fetch weather data for " + city;
    }
...
//            System.out.println(currentWeatherJson.toJSONString());
            ...
            return "Current Time: " + time + " Current Temperature (C): " + temperature + " Relative Humidity: " + relativeHumidity + " Weather Description: " + windSpeed;
